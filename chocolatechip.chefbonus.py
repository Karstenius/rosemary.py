...
# Chocolate chip cookies for multiples of 8
cookies = 5
...
# Rosemary tastes some of the batter, because everyone likes cookie batter.
Rosemary.taste(bowl)
...
for i in range(8 * cookies):
    bakingtray.add(bowl.take('1/' + str(8 * cookies)))
oven.add(bakingtray)
...
# After letting it cool, remove the cookies from the baking tray and place them on the plate
